...
const presetKey = this.themeState()?.preset as keyof typeof presets;
const presetPalette = presetKey ? presets[presetKey].primitive : undefined;
    ...
    const palettes: { name: string; palette: Palette }[] = [{ name: 'noir', palette: {} }];
